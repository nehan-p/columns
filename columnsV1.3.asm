...
bne, $t5, $t4, check_next_pixel                     # check if the colour at the current address is red
...
## the initialize_next_colours function (START FOR NEW CODE)
